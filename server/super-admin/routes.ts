    ...
    try {
      ...
      const [{ error: settingsError }, { error: userError }, { error: membershipError }, { error: stundensaetzeError }, { error: statusPipelineError }, { error: pdfVorlagenError }] = await Promise.all([
        client.from("einstellungen").insert([
          ...
          { tenant_id: tenant.id, schluessel: "adresse", wert: "" },
          { tenant_id: tenant.id, schluessel: "plz_ort", wert: "" },
          { tenant_id: tenant.id, schluessel: "telefon", wert: "" },
          { tenant_id: tenant.id, schluessel: "email", wert: "" },
          { tenant_id: tenant.id, schluessel: "uid_nummer", wert: "" },
          { tenant_id: tenant.id, schluessel: "bank_iban", wert: "" },
          { tenant_id: tenant.id, schluessel: "bank_name", wert: "" },
        ]),
