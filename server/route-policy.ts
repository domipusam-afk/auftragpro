...
export const ROUTE_POLICIES = [
  ...
  { method: "PATCH", path: "/api/super-admin/tenants/:id", line: 357, source: "super-admin", access: "admin-only", permissions: [], reason: "Firma umbenennen oder Status ändern.", currentEnforcement: "guarded" },
  { method: "POST", path: "/api/super-admin/tenants/:id/activate", line: 399, source: "super-admin", access: "admin-only", permissions: [], reason: "Firma aktivieren.", currentEnforcement: "guarded" },
  { method: "POST", path: "/api/super-admin/tenants/:id/deactivate", line: 400, source: "super-admin", access: "admin-only", permissions: [], reason: "Firma deaktivieren.", currentEnforcement: "guarded" },
  { method: "GET", path: "/api/super-admin/tenants/:tenantId/benutzer", line: 402, source: "super-admin", access: "admin-only", permissions: [], reason: "Mitarbeiter einer Firma ansehen.", currentEnforcement: "guarded" },
  { method: "POST", path: "/api/super-admin/tenants/:tenantId/benutzer", line: 410, source: "super-admin", access: "admin-only", permissions: [], reason: "Mitarbeiter einer Firma anlegen.", currentEnforcement: "guarded" },
  { method: "PATCH", path: "/api/super-admin/tenants/:tenantId/benutzer/:id", line: 438, source: "super-admin", access: "admin-only", permissions: [], reason: "Mitarbeiter einer Firma bearbeiten.", currentEnforcement: "guarded" },
  { method: "POST", path: "/api/super-admin/tenants/:tenantId/benutzer/:id/reset-password", line: 470, source: "super-admin", access: "admin-only", permissions: [], reason: "Mitarbeiterpasswort zurücksetzen.", currentEnforcement: "guarded" },
  { method: "GET", path: "/api/super-admin/tenants/:tenantId/branding", line: 490, source: "super-admin", access: "admin-only", permissions: [], reason: "Branding einer Firma lesen.", currentEnforcement: "guarded" },
  { method: "PATCH", path: "/api/super-admin/tenants/:tenantId/branding", line: 501, source: "super-admin", access: "admin-only", permissions: [], reason: "Branding einer Firma ändern.", currentEnforcement: "guarded" },
  { method: "GET", path: "/api/super-admin/audit-log", line: 522, source: "super-admin", access: "admin-only", permissions: [], reason: "Systemweites Audit-Log ansehen.", currentEnforcement: "guarded" },
