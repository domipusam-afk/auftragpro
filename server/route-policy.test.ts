...
function run(): void {
  ...
  assert.equal(registered.length, 258, "Die bestätigte Anzahl der Express-Routen darf nicht unbemerkt abweichen.");
  ...
  assert.equal(discrepancies.length, 225, "Die erwarteten, noch nicht aktivierten Ziel-Gates müssen vollständig sichtbar bleiben.");
