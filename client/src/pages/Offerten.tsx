            ...
            {offerten.map(o => {
              ...
              return (
                <div key={o.id} className="p-4 hover:bg-muted/30 transition-colors">
                  {/* Titel-Zeile IMMER als eigene volle Zeile ueber der Button-Zeile:
                      auf schmalen Mobile-Screens reicht der Platz nie fuer Titel +
                      Status-Dropdown + PDF + E-Mail + Loeschen in einer Reihe.
                      flex-col (mobil) -> sm:flex-row (Desktop, genug Breite) statt
                      flex-wrap, damit der Umbruch garantiert VOR der Titel-Zeile
                      passiert und nicht mitten im Titel-Text (unabhaengig von
                      Browser-spezifischer Flex-Wrap-Berechnung). */}
